document.addEventListener( 'DOMContentLoaded' , () => {
  //evento donde js se dispara cuando el navegador ha cargado y analizado el html
  ...
  document.addEventListener( 'click' , (event) => {
    if( !mainNav.contains( event.target ) && !hamburgerButton.contains( event.target ) && mainNav.classList.contains( 'nav-open' ) ) {
...
boton.addEventListener('click', () => {
  //showmodal abre el dialogo, lo centra y añade fondo oscuro
  dialogo.showModal();
});
